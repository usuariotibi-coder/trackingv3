                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                        ...
                        if (active && payload?.length) {
                          ...
                          return (
                            <div className="bg-white p-3 border-none shadow-2xl rounded-xl text-[10px] ring-1 ring-black/5">
                              <p className="font-black uppercase mb-1 border-b pb-1">
                                {d.name}
                              </p>
                              <p className="flex justify-between gap-6">
                                <span>Real:</span>{" "}
                                <b>{formatDuration(d.real)}</b>
                              </p>
                              <p className="flex justify-between gap-6 text-blue-600 font-bold border-t mt-1 pt-1">
                    ...
                    <Bar
                      ...
                      barSize={24}
                    >
                      {stats.porProceso.map((entry, index) => (
                        <Cell
                          key={`cell-${index}`}
                          fill={
                            entry.eficiencia > 85
